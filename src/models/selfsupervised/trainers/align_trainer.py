...
from src.models.selfsupervised.models.align_model import ALIGNTrainer, train, test
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        print('==> training')        
        t = train(model, args, train_dl,
            logger=neptune_logger,
            load_state_prefix=args.load_state_simclr)
        test(model, args, test_dl, trainer=t, logger=neptune_logger)
